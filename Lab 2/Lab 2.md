...
1.  From the **Azure portal**, (+++**https://portal.azure.com**+++)
    **Home** page, type in +++**storage account**+++ in the search bar
    and select the **Storage accounts**.
...
3.  On the Create a storage account page, enter the below details.
...
- Region – Select the **Region** in which you had created your **AML
  Workspace**
...
4.  On the Advanced tab, ensure that the option **Allow cross-tenant
...
7.  Keep a note of the Storage account name as this will be used in the
...
18. Click **Next** from the **Quality control(preview)** page.
...
This entire set of tasks also belongs to the **Data: Explore & prepare**
