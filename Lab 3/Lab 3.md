...
1.  From the Azure portal Home page, select your assigned **Resource
    group** from the **Resources** tab. From the left pane, select
...
4.  In order to register the feature set spec with the feature store, it
    ...
    the next cell.![A screenshot of a computer program Description
